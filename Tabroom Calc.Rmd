...
round1.df1 = data.frame(Team = team1, Speaker = R1PFirstSpeaker, Points = round1matrix[,1])
#row.names(round1.df1) = team1
round1.df2 = data.frame(Team = team1, Speaker = R1PSecondSpeaker, Points = round1matrix[,2])
